...
use Cipriano\Core\criteria\MovimientoGastoCriteria;

use Cipriano\Core\service\ServiceFactory;

use Cipriano\Core\utils\CiprianoUtils;

use Cipriano\Core\model\MovimientoGasto;
...
use Cipriano\Core\service\IGastoService;
...
class GastoServiceImpl extends CrudService implements IGastoService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Cipriano/Core/service/Cipriano\Core\service.IGastoService::pagar()
	 */
	public function pagar(Gasto $gasto, Cuenta $cuenta, User $user, $fechaHora){
		...
		$movimiento->setConcepto( CiprianoUtils::getConceptoMovimientoGasto() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Cipriano/Core/service/Cipriano\Core\service.IGastoService::anular()
	 */
	public function anular(Gasto $gasto, User $user){
		...
		if( $gasto->getEstado() == EstadoGasto::Pagado ){
			...
			$contramovimiento->setConcepto( CiprianoUtils::getConceptoMovimientoAnulacionGasto() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Cipriano/Core/service/Cipriano\Core\service.IGastoService::getGastosPorVencer()
	 */
