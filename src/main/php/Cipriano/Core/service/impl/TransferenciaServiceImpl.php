...
use Cipriano\Core\criteria\MovimientoTransferenciaCriteria;

use Cipriano\Core\model\EstadoTransferencia;

use Cipriano\Core\service\ITransferenciaService;

use Cipriano\Core\model\Transferencia;

use Cipriano\Core\service\ServiceFactory;

use Cipriano\Core\model\MovimientoTransferencia;
...
class TransferenciaServiceImpl extends CrudService implements ITransferenciaService {
	...
	function add( $entity ){
		...
		if ($entity->getOrigen()) {
			...
			$movimiento->setConcepto( CiprianoUtils::getConceptoMovimientoTransferencia() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Cipriano/Core/service/Cipriano\Core\service.ITransferenciaService::anular()
	 */
	public function anular(Transferencia $transferencia, User $user){
		...
		$contramovimiento->setConcepto( CiprianoUtils::getConceptoMovimientoAnulacionTransferencia() );
