...
use Cipriano\Core\service\IPagoService;
...
class PagoServiceImpl extends CrudService implements IPagoService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Cipriano/Core/service/Cipriano\Core\service.IVentaService::anular()
	 */
	public function anular(Pago $pago, User $user){
		...
		if( $pago->getEstado() == EstadoPago::Realizado ){
			...
			$conceptoAnulacion = CiprianoUtils::getConceptoMovimientoAnulacionPago();
