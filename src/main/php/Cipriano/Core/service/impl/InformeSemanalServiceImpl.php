...
use Cipriano\Core\service\IInformeSemanalService;
...
class InformeSemanalServiceImpl extends CrudService implements IInformeSemanalService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Cipriano/Core/service/Cipriano\Core\service.IInformeSemanalService::getInformeAnualPorMes()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Cipriano/Core/service/Cipriano\Core\service.IInformeSemanalService::getInformeAnualPorSemana()
	 */
