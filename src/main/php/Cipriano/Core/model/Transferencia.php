 ...
 * Transferencia
 *
 * Transferencia entre Cipriano
 *
 * @Entity @Table(name="cipriano_transferencia")
 *
*  @author Marcos
 * @since 02-08-2018
 */
...
class Transferencia extends Entity{
	...
	public function __toString(){
		 return $this->getOrigen() . " -> " . $this->getDestino() . " : " . CiprianoUtils::formatMontoToView( $this->getMonto() );
	}
