<?php
namespace Cipriano\Core\dao\impl;

use Cipriano\Core\model\MovimientoGasto;

use Cipriano\Core\dao\IMovimientoCuentaDAO;

use Cipriano\Core\dao\IMovimientoVentaDAO;

use Cipriano\Core\model\MovimientoVenta;

use Cipriano\Core\model\ConceptoMovimiento;

use Cipriano\Core\dao\IConceptoMovimientoDAO;

use Cipriano\Core\criteria\ConceptoMovimientoCriteria;
...
class MovimientoCuentaDoctrineDAO extends CrudDAO implements IMovimientoCuentaDAO{
	...
	protected function getClazz(){
		return "Cipriano\Core\model\MovimientoCuenta";
	}
