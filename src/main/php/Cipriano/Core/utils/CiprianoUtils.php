...
class CiprianoUtils {
	...
	const CTS_CUENTA_JOSEFINA = 1;
	const CTS_CUENTA_MARIAS = 2;
	...
	public static function getCuentaJosefina(){

		return ServiceFactory::getBancoService()->get( self::CTS_CUENTA_JOSEFINA );
	}

	public static function getCuentaCasa(){

		return ServiceFactory::getBancoService()->get( self::CTS_CUENTA_CASA );
	}

	public static function getCuentaMARIAS(){

		return ServiceFactory::getBancoService()->get( self::CTS_CUENTA_MARIAS );
	}

	public static function getCuentaCamion(){

		return ServiceFactory::getBancoService()->get( self::CTS_CUENTA_CAMION );
	}
	...
	public static function sendMailPop($nameTo, $to, $subject, $msg, $attachs) {
		...
		$libsHome= CiprianoConfig::getInstance()->getLibsPath();
        ...
        if( CiprianoConfig::TEST_MODE ){
        	//me los envío todos a mi en test
        	$to = CiprianoConfig::TEST_MAIL_TO;
        }
		...
		$mail->Host = CiprianoConfig::POP_MAIL_HOST;
		//Set the SMTP port number - likely to be 25, 465 or 587
		$mail->Port = CiprianoConfig::POP_MAIL_PORT;
		$mail->SMTPSecure = CiprianoConfig::POP_MAIL_SMTP_SECURE;
		//Whether to use SMTP authentication
		$mail->SMTPAuth = true;
		//Username to use for SMTP authentication
		$mail->Username = CiprianoConfig::POP_MAIL_USERNAME;
		//Password to use for SMTP authentication
		$mail->Password = CiprianoConfig::POP_MAIL_PASSWORD;

		//Set who the message is to be sent from
		$mail->setFrom(CiprianoConfig::MAIL_FROM, CiprianoConfig::MAIL_FROM_NAME);
		//Set an alternative reply-to address
		$mail->addReplyTo(CiprianoConfig::MAIL_FROM, CiprianoConfig::MAIL_FROM_NAME);
    ...
    public static function sendMail($nameTo, $to, $subject, $msg, $attachs) {
        ...
        if (CiprianoConfig::MAIL_ENVIO_POP)
